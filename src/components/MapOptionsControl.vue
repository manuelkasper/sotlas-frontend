  ...
  methods: {
    ...
    showActivationZoneInfo (event) {
      ...
      this.$buefy.dialog.alert({
        ...
        message: '<p style="margin-bottom: 0.5em">Activation zone boundaries are currently available for the following associations/regions:</p><ul><li style="margin-bottom: 0.5em"><strong>ER</strong><br />Derived from 1 arc-second SRTM data.</li><li style="margin-bottom: 0.5em"><strong>F, FL</strong><br />Calculated using IGN RGE ALTI Digital Terrain Model 1m.</li><li style="margin-bottom: 0.5em"><strong>G</strong><br />Calculated using Environment Agency LIDAR Composite DTM 1 m WCS data.</li><li style="margin-bottom: 0.5em"><strong>GM</strong><br />Calculated using Scottish Remote Sensing Portal DTM catalogue and survey GeoTIFFs, including eligible Scottish National Land LiDAR Programme releases; survey-specific OGL coverage at 1 m or finer.</li><li style="margin-bottom: 0.5em"><strong>GW</strong><br />Calculated using Welsh Government 32-bit DTM Cloud Optimized GeoTIFFs.</li><li style="margin-bottom: 0.5em"><strong>HB/HB0</strong><br />Calculated using <a href="https://www.swisstopo.admin.ch/de/geodata/height/alti3d.html" target="_blank">swissALTI3D</a> data from swisstopo (spatial resolution 0.5 m, accuracy ± 0.3 – 3 m (1σ) depending on the region).</li><li style="margin-bottom: 0.5em"><strong>OE</strong><br />Calculated using <a href="https://data.bev.gv.at/geonetwork/srv/ger/catalog.search;jsessionid=1F5F6A9D0278E6871FEDB6B87EE0936B#/metadata/eae5f98d-d605-4783-8292-8b913d163cac" target="_blank">BEV ALS DTM</a> data (spatial resolution 1 m, accuracy generally ± 0.5 m, may vary in high altitude).</li><li style="margin-bottom: 0.5em"><strong>OK</strong><br />Calculated from the 5th Generation Digital Relief Model of the Czech Republic, an official high-precision digital geographic dataset managed by the Czech Office for Surveying, Mapping and Cadastre (ČÚZK) created by airborne laser scanning (LIDAR).</li><li style="margin-bottom: 0.5em"><strong>OM</strong><br />Calculated using LiDAR DTM data (spatial resolution 20 m).</li><li style="margin-bottom: 0.5em"><strong>SP</strong><br />Calculated using 1 m resolution Digital Terrain Model (NMT) from the Head Office of Geodesy and Cartography (GUGiK), derived from LiDAR surveys (EVRF2007 vertical reference).</li><li style="margin-bottom: 0.5em"><strong>KH0, KH2, KH6, KH8, KLA, KP4, W</strong><br />Calculated using data from the U.S. Geological Survey 3D Elevation Program (3DEP).</li><li style="margin-bottom: 0.5em"><strong>W7W</strong><br />Calculated using data from <a href="https://lidarportal.dnr.wa.gov/" target="_blank">Washington State’s Department of Natural Resources public LiDAR portal</a>.</li><li style="margin-bottom: 0.5em"><strong>ZL</strong><br />Based on LiDAR data (generalised to a 4m x 4m grid) where available, or NZSoSDEM 15m contour-derived DEM grid otherwise.</li></ul><hr /><p style="font-size: 0.8em">The activator is always responsible for ensuring that the operation takes place within the activation zone.</p>',
        type: 'is-info',
        hasIcon: true,
        icon: 'info-circle',
        iconPack: 'fas'
